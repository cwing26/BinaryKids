...
public class GamePage extends JPanel {
	...
	public GamePage(Controller _controller) {
	...
	//expected answer 
	public String padAnswer(String number) {
	...
	public String convertToBin (int i) {
	...
	public void paint(Graphics g) {
		...
		//otherwise, display everything else
			...
			int placeStringHeight = oneYCoord + oneHeight + PLACE_PADDING + 5;
