...
public class binaryApplicationPage extends JPanel
{
	...
	public JLabel convertLabel;
	
	//components for on off switch
	private JButton oneButton;
	private JButton zeroButton;
	public boolean oneClicked = false;
	...
	//constructor
    public binaryApplicationPage(Controller welcome)
    {
    	controller = welcome;
